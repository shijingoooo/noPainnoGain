...
public class Reflect {
    ...
    public static void Demo2() throws ClassNotFoundException
    {
        ...
        class1 = Class.forName("com.shijing.Reflect.Person");
    ...
    {
        Class<?> class1 = null;
        class1 = Class.forName("com.shijing.Reflect.SuperMan");
     ...
     * @throws InstantiationException
     */
    public static void Demo7() throws ClassNotFoundException, SecurityException
            ...
            , InvocationTargetException, InstantiationException
    {
        ...
        method = class1.getMethod("walk",int.class, int.class);
        method.invoke(class1.newInstance(),100, 100);
    }
